            ...
            <Form labelAlign="left" className="ant-advanced-search-form" onSubmit={this.handleSubmit}>
                ...
                <Row type="flex" gutter={24}>
                    ...
                    <Col span={11} key={"plaka"}>
                        ...
                        {getFieldDecorator('Plaka', {
                                    rules: [{required: true, message: 'Lütfen plakayı kontrol edin'}, {
                ...
                <Row type="flex" gutter={24}>
                    ...
                    <Col span={11} key={"aracresim"}>
                        <Form.Item labelAlign="left" label="Araç Resimleri" labelCol={{ span: 4 }}>
                            {getFieldDecorator('dragger', {
                                valuePropName: 'fileList',
                                getValueFromEvent: this.normFile,
                            })(
                                <Upload.Dragger multiple name="files" action="/upload.do" listType="picture">
                                    <p className="ant-upload-drag-icon">
                                        <Icon type="picture" />
                                    </p>
                                    <p className="ant-upload-text">Araç resimleri eklemek için buraya tıklayın veya sürükleyin</p>
                                </Upload.Dragger>
                            )}
                        </Form.Item>
                    </Col>
                        ...
                        <Form.Item label="Ruhsat Resimleri" labelCol={{ span: 4 }}>
                            {getFieldDecorator('dragger', {
                                ...
                                <Upload.Dragger multiple name="files" action="/upload.do" listType="picture">
                                    ...
                                    <p className="ant-upload-text">Ruhsat resimleri eklemek için buraya tıklayın veya sürükleyin</p>
                                </Upload.Dragger>,
                            )}
                        </Form.Item>
                    </Col>
